...
class Shop:
    ...
    def find_cheaper_than(self, cheaper_than_value):
        ...
        # print(self.products_and_prices.items())
...
print('Adding employee: ', candy_shop.add_employee('Betty'))
# print('Delete employee in shop', candy_shop.del_employee('Joanna'))
print('Adding product to our products: ', candy_shop.add_products('Dog Clothing', 9))
print('Finded product by name: ', candy_shop.find_prod_by_name('Dog Toys'))
print('Product cheaper than 5 :', candy_shop.find_cheaper_than(9))
print('New Owner of the Candy shop is: ', candy_shop.change_owner('Henry Tomson'))
print('Increased income of the Candy shop is: ', candy_shop.increase_income(3))